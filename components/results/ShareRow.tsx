...
export function ShareRow({ analysisId }: ShareRowProps) {
  ...
  const shareUrl = `${window.location.origin}/analyse/${analysisId}`
  ...
  const handleShareTwitter = () => {
    const text = `Check out my Soundarya beauty analysis! Scored ${shareUrl}`
    ...
    <div className="bg-white rounded-lg shadow-sm p-6">
      ...
      <div className="mt-4 p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg">
        <div className="flex items-center justify-between">
          <div>
            <h4 className="font-medium text-purple-900">Want the Full Report?</h4>
            <p className="text-sm text-purple-700">Unlock 20 detailed beauty tips for just $19</p>
          </div>
